  ...
  return (
    <div className="container">
      <div className="container__title">
        ...
        <Button className="btn btn--primary btn--sm" onClick={submit} name={Edit} />
      </div>
      ...
      {initialExerciseData.files && initialExerciseData.files.map((file, i) => <img className="exercise-image" key={i} alt={i} src={`data:image/jpeg;base64,${file}`} />)}
