...
export const UsersPanel = ({
  bottomSheet, setBottomSheet, activeUsers, setAssignPlan,
}) => {
  const dispatch = useDispatch();
        ...
        : (
          <>
            <div className="bottom-sheet-item__oneline">
              ...
              <div onClick={() => deleteUser()} className="bottom-sheet-item__content">
              ...
              <div onClick={() => setAssignTrainer(!assignTrainer)} className="bottom-sheet-item__content">
