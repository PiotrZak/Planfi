...
const App = () => {
  ...
  const renderLangChange = () => <LanguageSelector />;

  const renderThemeChange = () => <ThemeSelector toggleTheme={toggleTheme} />;
          ...
          <userContext.Provider value={{ user }}>
            ...
            <BrowserRouter history={history}>
              ...
              <Switch>
                ...
                <PrivateRoute user={user} path="/organizations" component={Organizations} />
