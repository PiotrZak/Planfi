...
export const RenderType = ({ theme, type, element, i, interaction }) => {
      ...
      case 'users':
        return (
          <StyledGenericElement
            key={i}
            onClick={() =>
              interaction && redirectToItem(possibleTypes.user, element.user_Id)
            }
            version={theme}
            avatarType="circle"
      ...
      case 'plans':
        return (
          <StyledGenericElement
            onClick={() =>
              interaction &&
              redirectToItem(possibleTypes.plan, element.planId, element.title)
            }
            version={theme}
            avatarType="noAvatar"
            key={i}
      ...
      case 'exercises':
        return (
          <StyledGenericElement
            ...
            onClick={() =>
              redirectToItem(possibleTypes.exercises, element.exerciseId)
            }
            headline={element.name}
            subline={
              element.series ? `${element.series.length} serie` : undefined
            }
            exercise={element}
          />
        )
  ...
  return <>{renderType(type, element, i)}</>
}
