  ...
  return (
    <Container>
      <Button
        ...
        id="switched-button-1"
        active={activeTabID === 'switched-button-1'}
      >
        <StyledParagraph type="Label-Button" id="switched-button-1">
          {firstButtonText}
        </StyledParagraph>
      </Button>
      <Button
        ...
        id="switched-button-2"
        active={activeTabID === 'switched-button-2'}
      >
        <StyledParagraph type="Label-Button" id="switched-button-2">
          {secondButtonText}
        </StyledParagraph>
      </Button>
    </Container>
